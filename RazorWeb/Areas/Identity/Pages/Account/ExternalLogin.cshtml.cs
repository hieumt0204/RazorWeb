    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //Claim ~ đặc tính mô tả đối tượng
                ...
                {
                    ModelState.AddModelError(string.Empty,"Không hỗ trợ tài khoản mới - có email khác với dịch vụ ngoài");
                    return Page();
                }
                ...
                if((externalEmailUser == null)  && (externalEmail == Input.Email))
                {
                    ...
                    {
                        _userManager.AddLoginAsync(newUser, info);
